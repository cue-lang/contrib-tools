...
- Create a work branch: git checkout -b my-branch (off the current
  branch, which is typically the upstream tip). The codereview
  workflow does not require git codereview change to create the
  branch; plain git checkout -b works
...
- Download an existing CL to work on: git codereview change NNNN
  (this is the one branch operation with no plain-git equivalent,
  since it fetches Gerrit refs)
